import { Options } from '@components/Input/components/Options';
import { classes } from '@components/Input/style';
import { useFilteredOptions } from '@components/Input/helpers/useFilterOptions';
import { InputProps, INPUT_TYPES } from '@constant/components/InputTypes';
import { useClickOutside } from '@hooks/useClickOutside';
import React, { useState, useRef, useEffect } from 'react';
import { InputElement } from '@components/Input/components/InputElement';
