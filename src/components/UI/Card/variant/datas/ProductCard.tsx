...
import { ProductContentProps } from '@components/types/card';
  ...
  return (
    <Box>
      <Box
        align="center"
        justify="center"
        className="flex size-8 translate-x-[-10px] translate-y-[-10px] rounded-full bg-primary text-white"
      >
      ...
      <Box align="start" justify="between" className="flex">
        ...
        <Box className="flex gap-px text-yellow-400">
