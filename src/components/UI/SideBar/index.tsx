  ...
  const getNavLinkClass = (isActive: boolean) =>
    cn(
      ...
      isActive
        ...
        : 'hover:text-grey-900 text-gray-900 hover:bg-soft-blue dark:text-white dark:hover:bg-dark-primary'
    );
          ...
          <SidebarItemGroup key={category}>
            ...
            {items.map(({ href, icon: Icon, label, subItems }) => {
              const isAnySubItemActive =
                subItems?.some(sub => location.pathname.startsWith(sub.href)) ??
                false;
