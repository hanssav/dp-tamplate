...
const SelectTrigger = React.forwardRef<
  React.ElementRef<typeof SelectPrimitive.Trigger>, // ElementRef : take ref type
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> // ComponentPropsWithoutRef : take props type whitout ref
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'placeholder:text-muted-foreground flex h-10 !w-full items-center justify-between rounded-md border border-gray-300 px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:bg-transparent dark:focus:bg-transparent [&>span]:line-clamp-1',
      className
    )}
    {...props}
  >
