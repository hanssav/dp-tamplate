...
export const datepickerTheme = createTheme({
  root: {
    base: 'relative bg-white dark:bg-gray-900',
    input: {
      field: {
        input: {
          base: 'w-full border border-gray-300 dark:border-gray-700 dark:bg-bg-dark',
          colors: {
            primary: 'bg-white',
          },
        },
  ...
  popup: {
    ...
    header: {
      ...
      selectors: {
        ...
        button: {
          base: 'rounded-lg bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600',
          prev: 'rounded-full',
          next: 'rounded-full',
          view: '',
        },
